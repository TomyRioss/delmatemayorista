...
export default function PersonalizadosPage() {
  ...
  return (
    <div className="flex flex-1 flex-col overflow-x-hidden bg-[#FEFCFB]">
      {/* Versión Mobile: imagen completa sin recortes ni márgenes */}
      <div className="block sm:hidden">
        <Image
          src="/informativas/personalizados/mobile-responsive.png"
          alt="Productos personalizados - Mayorista Del Mate"
          width={1500}
          height={1024}
      ...
      <main className="mx-auto hidden w-full max-w-[1500px] px-4 py-8 sm:block sm:px-6">
        ...
        <Image
          src="/informativas/personalizados/desktop.png"
